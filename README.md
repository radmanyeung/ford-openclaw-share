...
```bash
openclaw --version    # 應顯示 2026.3.28 或更高
```
...
| [OpenClaw Cases（實戰案例）](https://openclawcases.zeabur.app/) | 社群實戰案例同經驗分享 |
...
| [v2026.3.28 Release Notes](https://github.com/openclaw/openclaw/releases/tag/v2026.3.28) | 最新版本 changelog |
